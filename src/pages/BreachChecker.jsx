    ...
    >
      ...
      {result !== null && (
        <div className="max-w-xl mx-auto">
          {result.length === 0 ? (
            <div
              className={`rounded-xl p-6 text-center ${darkMode ? "bg-gray-800" : "bg-white shadow-md"}`}
            >
            ...
            <div
              className={`rounded-xl p-6 ${darkMode ? "bg-gray-800" : "bg-white shadow-md"}`}
            >
              <p className="text-red-400 text-xl font-semibold mb-4">
                ⚠️Found in{result.length}breach(es)!
              </p>
