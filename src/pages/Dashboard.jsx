...
function Dashboard() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`max-w-3xl mx-auto rounded-xl p-6 mb-10 ${darkMode ? "bg-gray-800" : "bg-white shadow-md"}`}
      >
        <h2 className="text-xl font-semibold text-green-400 mb-6">
          IP Abuse Score Comparison
        </h2>
      ...
      <div
        className={`max-w-3xl mx-auto rounded-xl p-6 ${darkMode ? "bg-gray-800" : "bg-white shadow-md"}`}
      >
        <h2 className="text-xl font-semibold text-green-400 mb-6">
          Top Data Breaches (Millions of Records)
        </h2>
        <ResponsiveContainer width="100%" height={300}>
          <PieChart>
            <Pie
